...
---
*Generated by [Runtime PR Verification](https://github.com/your-org/runtime-pr-verification) • ${new Date().toLocaleString()}*`;
            const existingComment = await this.findExistingComment();
            if (existingComment) {
                await this.octokit.rest.issues.updateComment({
                    owner: this.owner,
...
**Status**: ${result.status.charAt(0).toUpperCase() + result.status.slice(1)} | `;
        ...
        comment += `---\n*Generated by [Runtime PR Verification](https://github.com/your-org/runtime-pr-verification) • ${timestamp}*`;
        return comment;
    }

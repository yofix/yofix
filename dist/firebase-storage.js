...
const firebase_error_handler_1 = require("./firebase-error-handler");
class FirebaseStorageManager {
    ...
    initializeFirebase(serviceAccountBase64) {
        firebase_error_handler_1.FirebaseErrorHandler.validateFirebaseConfig({
        ...
        try {
            ...
            firebase_error_handler_1.FirebaseErrorHandler.handleError(error, 'Firebase Storage initialization');
        }
    }
    ...
    async uploadScreenshots(screenshots) {
        ...
        for (const screenshot of screenshots) {
            try {
                const uploadedScreenshot = await firebase_error_handler_1.FirebaseErrorHandler.withErrorHandling(async () => {

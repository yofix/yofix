/**
 * Pre-defined fix templates for common visual issues
 */
export class FixTemplates {
   ...
   */
  getTemplate(issueType: string): FixTemplate | undefined {
    return this.templates.get(issueType);
  }

  /**
   * Initialize common fix templates
   */
  private initializeTemplates(): void {
    // Layout shift / overlap issues
